 ...
 */
const search = (url, disableOrder = false, allowSwap = false, customParams = {}, proxy) => {
    return new Promise(async (resolve, reject) => {
        ...
        if(proxy) {
            useragent = new HttpsProxyAgent('http://' + random(proxy));
            console.log(`[*] Using proxy ${useragent.proxy.href}`);
        }
